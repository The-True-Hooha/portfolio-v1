...
const HeroSection = () => {
  return (
    <div className="py-[180px] px-[60px] text-left sm:px-[60px] lg:px-[290px] flex-auto sm:flex-auto lg:flex-auto">
      ...
      <div className="font-SFMono text-[20px] text-white sm:text-[25px] lg:mt-[30px] mt-6">
        <Link href="/">
          <a
            target="_blank"
            className="border hover:bg-[#9db03c] px-3 py-2 text-sm border-white rounded"
          >
            Resume
          </a>
        </Link>
