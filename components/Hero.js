...
const HeroSection = () => {
  return (
    <div
      id="home"
      className="py-[180px] px-[60px] w-full text-left md:px-[60px] lg:px-[150px]"
    >
      <div className="text-justify">
        <h2 className="font-SFMono text-[16px]">Hello, my name is</h2>
        <h1 className="text-white font-calibre text-[38px] font-bold mt-[8px]">
          David Ogar.
        </h1>
        <h2 className="font-calibre text-[20px] font-semibold mt-[15px]">
          A Software Engineer
        </h2>
      ...
      <div className="font-SFMono text-[20px] text-white md:text-[25px] lg:mt-[30px] mt-10">
        <Link href="https://drive.google.com/file/d/1A-u-ZUw8c5o1adK_Z1Ww5RROgbcY5WBU/view?usp=sharing">
          <a
            target="_blank"
